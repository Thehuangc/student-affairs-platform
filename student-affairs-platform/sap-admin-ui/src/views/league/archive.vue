  ...
  <div class="page-scene">
    <div class="page-header">
      <div class="header-info">
        <div class="header-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"/></svg></div>
        <div><h1>电子档案</h1><p>管理团员电子档案</p></div>
      </div>
    </div>
...
.page-header { padding: 28px 32px; background: linear-gradient(135deg, var(--vermillion) 0%, #e04e44 100%); border-radius: var(--radius-xl); }
